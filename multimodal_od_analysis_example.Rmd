...
# The following analysis only allows one PT mode to be used in a trip (max_rides=1), as its purpose 
# is to inform modelling which requires trip chaining not be undertaken.
# Alternately, the mode 'TRANSIT' could be run, with modification of max_rides=3, to allow a modest
# number of transfers across different transit options.
